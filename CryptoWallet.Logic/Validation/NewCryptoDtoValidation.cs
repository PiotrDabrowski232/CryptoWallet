...
{
    public class NewCryptoDtoValidation : AbstractValidator<NewCryptoDto>
    {
        public NewCryptoDtoValidation() { }
        public NewCryptoDtoValidation(CryptoWalletDbContext dbContext)
        {
            RuleFor(x => x.Name)
                .NotEmpty()
